...
import org.frc5902.robot.util.flywheellib.mathutil.quadratics.QuadraticRoots;
import org.frc5902.robot.util.flywheellib.mathutil.quadratics.QuadraticRoots.QuadraticType;
...
public class QuadraticFunction implements BaseFunction {
    ...
    public Point[] getRootsAsPoints() {
        return new Point[] {new Point(getRoots().roots[0], 0), new Point(getRoots().roots[1], 0)};
    }
}
